...
- `@v1` — latest 1.x (moving target)
- `@v1.0.0` — strict pin to a specific release
- `@main` — bleeding edge (not recommended for production)

Breaking prompt changes go in a new major (`v2`) so existing consumers don't get surprises.
